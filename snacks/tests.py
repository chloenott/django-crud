...
class SnacksTests(TestCase):
    ...
    def test_model_string_representation(self):
        self.assertEqual(str(self.snack), "Doritos")

    def test_model_content(self):
        self.assertEqual(self.snack.title, "Doritos")
    ...
    def test_snack_list_view(self):
        ...
        self.assertContains(response, "Doritos")
    ...
    def test_snack_update_view(self):
        response = self.client.post(
            ...
            {
                "title": "Doritos Updated",
                "purchaser": self.user.id,
                "description": "I like Doritos."
            },
            follow=True
        )
    ...
    def test_snack_delete_view(self):
        ...
        self.assertTemplateUsed(response, 'snack_list.html')
        self.assertNotContains(response, 'Doritos')